...
— **[Installation](https://nebukam.github.io/PCGExtendedToolkit/installation.html) in your own project** (FAB, Gumroad, Source)
...
- The `PCGExElementsClipper` module includes a C++ modified port of the [Clipper2](https://github.com/AngusJohnson/Clipper2) Rust library created by Angus Johnson
