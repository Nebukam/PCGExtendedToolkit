...
FPCGExStagedTypeFilterConfig::FPCGExStagedTypeFilterConfig()
{
	RefreshFromRegistry();
}

void FPCGExStagedTypeFilterConfig::RefreshFromRegistry()
{
...
bool FPCGExStagedTypeFilterConfig::Matches(PCGExAssetCollection::FTypeId TypeId) const
{
...
#if WITH_EDITOR
void FPCGExStagedTypeFilterConfig::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
