 ...
 * 
 */
class PCGEXACTIONS_API FPCGExActionOperation : public FPCGExOperation
{
public:
...
{
	GENERATED_BODY()
	PCG_DECLARE_TYPE_INFO(PCGEXACTIONS_API)
};

UCLASS(Abstract, BlueprintType, ClassGroup = (Procedural), Category="PCGEx|Data")
class PCGEXACTIONS_API UPCGExActionFactoryData : public UPCGExFactoryData
{
	GENERATED_BODY()
...
class PCGEXACTIONS_API UPCGExActionProviderSettings : public UPCGExFactoryProviderSettings
{
	GENERATED_BODY()
