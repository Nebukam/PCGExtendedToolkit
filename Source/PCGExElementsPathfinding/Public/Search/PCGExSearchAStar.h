 ...
 * 
 */
UCLASS(MinimalAPI, meta=(DisplayName = "A*", ToolTip ="A* Search. Returns early with the least possible amount of traversed nodes.", PCGExNodeLibraryDoc="pathfinding/algorithms/search-a"))
