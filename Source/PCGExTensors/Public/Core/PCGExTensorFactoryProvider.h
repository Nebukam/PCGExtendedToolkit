...
{
	GENERATED_BODY()
	PCG_DECLARE_TYPE_INFO(PCGEXTENSORS_API)
};


UCLASS(Abstract, BlueprintType, ClassGroup = (Procedural), Category="PCGEx|Data")
class PCGEXTENSORS_API UPCGExTensorFactoryData : public UPCGExFactoryData
{
	GENERATED_BODY()
...
class PCGEXTENSORS_API UPCGExTensorFactoryProviderSettings : public UPCGExFactoryProviderSettings
{
	GENERATED_BODY()
...
UCLASS(Abstract, BlueprintType, ClassGroup = (Procedural), Category="PCGEx|Data")
class PCGEXTENSORS_API UPCGExTensorPointFactoryData : public UPCGExTensorFactoryData
{
	GENERATED_BODY()
...
UCLASS(Abstract, BlueprintType, ClassGroup = (Procedural), Category="PCGEx|Graph|Params")
class PCGEXTENSORS_API UPCGExTensorPointFactoryProviderSettings : public UPCGExTensorFactoryProviderSettings
{
	GENERATED_BODY()
