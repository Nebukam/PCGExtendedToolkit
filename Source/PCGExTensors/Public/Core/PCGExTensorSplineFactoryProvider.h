...
class PCGEXTENSORS_API UPCGExTensorSplineFactoryData : public UPCGExTensorFactoryData
{
	GENERATED_BODY()
...
class PCGEXTENSORS_API UPCGExTensorSplineFactoryProviderSettings : public UPCGExTensorFactoryProviderSettings
{
	GENERATED_BODY()
