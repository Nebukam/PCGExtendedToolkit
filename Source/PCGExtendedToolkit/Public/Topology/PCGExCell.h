...
namespace PCGExTopology
{
	...
	bool IsPointInPolygon(const FVector2D& Point, const FGeometryScriptSimplePolygon& Polygon);
	bool IsPointInPolygon(const FVector& Point, const FGeometryScriptSimplePolygon& Polygon);
