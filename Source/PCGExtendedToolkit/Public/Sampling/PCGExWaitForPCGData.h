...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = Settings, meta = (PCG_Overridable, DisplayName=" └─ Timeout", EditCondition="bWaitForMissingActors", EditConditionHides, ClampMin=0.001, ClampMax=30))
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = Settings, meta = (PCG_Overridable, EditCondition="bDoMatchGenerationTrigger"))
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = Settings, meta = (PCG_Overridable, DisplayName=" └─ Invert", EditCondition="bDoMatchGenerationTrigger", EditConditionHides, HideEditConditionToggle))
	double bInvertGenerationTrigger = false;
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = Settings, meta = (PCG_Overridable, DisplayName=" └─ Force Generation", EditCondition="bTriggerOnDemand", EditConditionHides))
	bool bForceGeneration = true;

	/** If enabled, pins values are cached. */
	//UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = Settings, meta = (PCG_Overridable))
	bool bCachePins = true;
...
namespace PCGExWaitForPCGData
{
	...
	protected:
		...
		void WatchComponent(UPCGComponent* InComponent, int32 Index);
