...
{
	class FCurveFloatLookup;
}

using PCGExFloatLUT = TSharedPtr<PCGExSampling::FCurveFloatLookup, ESPMode::ThreadSafe>;
...
#pragma region boilerplate
	...
	TSoftObjectPtr<UCurveFloat> ExternalCurve = TSoftObjectPtr<UCurveFloat>(PCGEx::WeightDistributionLinear);
...
#pragma endregion
	...
	PCGExFloatLUT MakeLookup(const bool InUseLocalCurve, FRuntimeFloatCurve RuntimeCurve, TSoftObjectPtr<UCurveFloat> InExternalCurve, const PCGExSampling::FInitCurveDataDefaults& InitFn) const;
	...
	PCGExFloatLUT MakeFloatLookup(const PCGExSampling::FInitCurveDataDefaults& InitFn) const;
...
namespace PCGExSampling
{
	...
	public:
		...
		{
			PCGExFloatLUT NewLUT = MakeShared<FCurveFloatLookup>();
