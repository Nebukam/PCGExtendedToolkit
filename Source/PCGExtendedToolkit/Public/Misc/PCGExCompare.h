...
public:
	...
	static int Compare(const T& A, const T& B, const double Tolerance = 0.0001f, EPCGExOrderedFieldSelection Comp = EPCGExOrderedFieldSelection::X)
	{
	...
	*/
	...
	template <typename dummy = void>
	static int Compare(const FVector2D& A, const FVector2D& B, const double Tolerance, EPCGExOrderedFieldSelection Comp)
	{
		int Result = 0;
		switch (Comp)
		{
	...
	template <typename dummy = void>
	static int Compare(const FVector& A, const FVector& B, const double Tolerance, EPCGExOrderedFieldSelection Comp)
	{
		int Result = 0;
		switch (Comp)
		{
	...
	template <typename dummy = void>
	static int Compare(const FVector4& A, const FVector4& B, const double Tolerance, EPCGExOrderedFieldSelection Comp)
	{
	...
	template <typename dummy = void>
	static int Compare(const FRotator& A, const FRotator& B, const double Tolerance, EPCGExOrderedFieldSelection Comp)
	{
		return Compare(FVector{A.Euler()}, FVector{B.Euler()}, Tolerance, Comp);
	}

	template <typename dummy = void>
	static int Compare(const FQuat& A, const FQuat& B, const double Tolerance, EPCGExOrderedFieldSelection Comp)
	{
		return Compare(FVector{A.Euler()}, FVector{B.Euler()}, Tolerance, Comp);
	}

	template <typename dummy = void>
	static int Compare(const FString& A, const FString& B, const double Tolerance, EPCGExOrderedFieldSelection Comp)
	{
		return A < B ? -1 : A == B ? 0 : 1;
	}

	template <typename dummy = void>
	static int Compare(const FName& A, const FName& B, const double Tolerance, EPCGExOrderedFieldSelection Comp)
	{
		return Compare(A.ToString(), B.ToString(), Tolerance, Comp);
	}

	template <typename dummy = void>
	static int Compare(const FTransform& A, const FTransform& B, const double Tolerance, EPCGExOrderedFieldSelection Comp)
	{
