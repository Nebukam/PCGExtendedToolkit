...
namespace PCGEx
{
	...
	namespace SubSelectionImpl
	{
		...
		PCGEXTENDEDTOOLKIT_API FExtractFieldFn GetExtractFieldFn(EPCGMetadataTypes Type);
		PCGEXTENDEDTOOLKIT_API FInjectFieldFn GetInjectFieldFn(EPCGMetadataTypes Type);
		PCGEXTENDEDTOOLKIT_API FExtractAxisFn GetExtractAxisFn(EPCGMetadataTypes Type);
	} // namespace SubSelectionImpl
	 ...
	 */
	struct PCGEXTENDEDTOOLKIT_API FCachedSubSelection
	{
		//
