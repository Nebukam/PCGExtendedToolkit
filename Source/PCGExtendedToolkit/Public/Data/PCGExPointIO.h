...
namespace PCGExData
{
	...
	public:
		FString TagId;
		FString TagValue;
		TArray<TSharedPtr<FPointIO>> Entries;
		...
		void Add(const TSharedPtr<FPointIO>& Value);
	};
	...
	public:
		...
		bool CreateKey(const TSharedPtr<FPointIO>& PointIOKey);
		bool TryAddEntry(const TSharedPtr<FPointIO>& PointIOEntry);
