...
#include "Data/TypeOperations/PCGExTypeOpsNumeric.h"
#include "Data/TypeOperations/PCGExTypeOpsVector.h"
#include "Data/TypeOperations/PCGExTypeOpsRotation.h"
#include "Data/TypeOperations/PCGExTypeOpsString.h"
...
namespace PCGExTypeOps
{
	...
	{
		return FTypeOps<TFrom>::template ConvertTo<TTo>(Value);
	}
	...
	{
		return FTypeOps<T>::Lerp(A, B, Alpha);
	}
	...
	{
		T Result = FTypeOps<T>::Max(Value, MinVal);
		return FTypeOps<T>::Min(Result, MaxVal);
	}
}
