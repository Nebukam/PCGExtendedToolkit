...
#include "PCGExDetailsFusing.generated.h"
...
struct PCGEXTENDEDTOOLKIT_API FPCGExFuseDetails : public FPCGExSourceFuseDetails
{
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = Settings, meta=(PCG_Overridable, EditCondition="FuseMethod == EPCGExFuseMethod::Voxel", EditConditionHides, DisplayName="Stabilize Insertion Order"))
	...
	uint64 GetGridKey(const FVector& Location, int32 PointIndex) const;
