...
struct PCGEXTENDEDTOOLKIT_API FPCGExFillControlConfigBase
{
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = Settings, meta = (PCG_NotOverridable, EditCondition="bSupportSource", EditConditionHides))
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = Settings, meta=(PCG_NotOverridable, Bitmask, BitmaskEnum="/Script/PCGExtendedToolkit.EPCGExFloodFillControlStepsFlags", EditCondition="bSupportSteps", EditConditionHides))
