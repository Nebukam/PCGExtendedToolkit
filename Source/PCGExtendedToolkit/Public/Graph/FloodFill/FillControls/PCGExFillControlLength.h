 ...
 * 
 */
UCLASS(MinimalAPI, DisplayName = "Length")
...
public:
	...
	virtual bool IsValidCandidate(const PCGExFloodFill::FDiffusion* Diffusion, const PCGExFloodFill::FCandidate& InCandidate) override;
