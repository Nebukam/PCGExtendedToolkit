...
void UPCGExSubPointsBlendOperation::BlendSubPoints(TArray<FPCGPoint>& SubPoints, const PCGExPaths::FPathMetricsSquared& Metrics, PCGExDataBlending::FMetadataBlender* InBlender) const
{
