...
UPCGExPathToEdgeClustersSettings::OutputPinProperties() const
{
...
#if WITH_EDITOR
void
UPCGExPathToEdgeClustersSettings::PostEditChangeProperty(
...
PCGExData::EInit
UPCGExPathToEdgeClustersSettings::GetMainOutputInitMode() const
{
    return PCGExData::EInit::NoOutput;
}

FName
UPCGExPathToEdgeClustersSettings::GetMainOutputLabel() const
{
...
bool
FPCGExPathToEdgeClustersElement::Boot(FPCGContext* InContext) const
{
    ...
    const_cast<UPCGExPathToEdgeClustersSettings*>(Settings)
...
bool
FPCGExPathToEdgeClustersElement::ExecuteInternal(FPCGContext* InContext) const
{
        ...
        if (Settings->bFusePaths) {
            ...
            if (!Context->StartBatchProcessingPoints<
                  ...
                  [&](PCGExPathToClusters::FFusingProcessorBatch* NewBatch) {
                      NewBatch->PointPointIntersectionSettings =
                        Settings->PointPointIntersectionSettings;
                  },
