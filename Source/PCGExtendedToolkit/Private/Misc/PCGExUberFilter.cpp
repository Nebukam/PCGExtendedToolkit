...
PCGExData::EInit UPCGExUberFilterSettings::GetMainOutputInitMode() const { return PCGExData::EInit::DuplicateInput; }
...
bool FPCGExUberFilterElement::ExecuteInternal(FPCGContext* InContext) const
{
	...
	if (Context->IsState(PCGExMT::State_ReadyForNextPoints))
	{
		...
		else
		{
			...
			Context->FilterManager->Register<UPCGExFilterDefinitionBase>(Context->FilterDefinitions, Context->CurrentIO);
