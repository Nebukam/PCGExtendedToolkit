...
{
	return MakeShared<PCGExPointsFilter::TDistanceFilter>(this);
}
...
bool PCGExPointsFilter::TDistanceFilter::Init(FPCGExContext* InContext, const TSharedPtr<PCGExData::FFacade> InPointDataFacade)
{
