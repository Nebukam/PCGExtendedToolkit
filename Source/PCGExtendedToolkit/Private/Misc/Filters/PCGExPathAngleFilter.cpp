...
#include "Misc/Filters/PCGExPathAngleFilter.h"


#define LOCTEXT_NAMESPACE "PCGExPathAngleFilterDefinition"
#define PCGEX_NAMESPACE PCGExPathAngleFilterDefinition

bool UPCGExPathAngleFilterFactory::Init(FPCGExContext* InContext)
{
...
bool UPCGExPathAngleFilterFactory::DomainCheck()
{
	return
...
TSharedPtr<PCGExPointFilter::FFilter> UPCGExPathAngleFilterFactory::CreateFilter() const
{
	return MakeShared<PCGExPointFilter::FPathAngleFilter>(this);
}

bool UPCGExPathAngleFilterFactory::RegisterConsumableAttributesWithData(FPCGExContext* InContext, const UPCGData* InData) const
{
...
bool PCGExPointFilter::FPathAngleFilter::Init(FPCGExContext* InContext, const TSharedPtr<PCGExData::FFacade>& InPointDataFacade)
{
...
bool PCGExPointFilter::FPathAngleFilter::Test(const int32 PointIndex) const
{
...
bool PCGExPointFilter::FPathAngleFilter::Test(const TSharedPtr<PCGExData::FPointIO>& IO, const TSharedPtr<PCGExData::FPointIOCollection>& ParentCollection) const
{
...
#if WITH_EDITOR
FString UPCGExPathAngleFilterProviderSettings::GetDisplayName() const
{
