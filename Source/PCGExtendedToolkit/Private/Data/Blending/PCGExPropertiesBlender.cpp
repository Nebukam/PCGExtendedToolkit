...
#undef PCGEX_BLEND_FUNCASSIGN
	...
	void PCGExDataBlending::FPropertiesBlender::PrepareBlending(FPCGPoint& Target, const FPCGPoint& Default)
	{
...
#undef PCGEX_BLEND_PROPDECL
	...
	void PCGExDataBlending::FPropertiesBlender::CompleteBlending(FPCGPoint& Target, const double Alpha)
	{
	...
	void PCGExDataBlending::FPropertiesBlender::PrepareRangeBlending(const TArrayView<FPCGPoint>& Targets, const FPCGPoint& Default)
	{
	...
	void PCGExDataBlending::FPropertiesBlender::CompleteRangeBlending(const TArrayView<FPCGPoint>& Targets, const double Alpha)
	{
