...
#include "Data/TypeOperations/PCGExTypeOpsImpl.h"
#include "Data/TypeOperations/PCGExTypeOperations.h"
...
namespace PCGExTypeOps
{
	...
	const ITypeOpsBase* FTypeOpsRegistry::Get(EPCGMetadataTypes Type)
	{
		switch (Type)
		{
		case EPCGMetadataTypes::Boolean:
			return &TTypeOpsImpl<bool>::GetInstance();
		case EPCGMetadataTypes::Integer32:
			return &TTypeOpsImpl<int32>::GetInstance();
		case EPCGMetadataTypes::Integer64:
			return &TTypeOpsImpl<int64>::GetInstance();
		case EPCGMetadataTypes::Float:
			return &TTypeOpsImpl<float>::GetInstance();
		case EPCGMetadataTypes::Double:
			return &TTypeOpsImpl<double>::GetInstance();
		case EPCGMetadataTypes::Vector2:
			return &TTypeOpsImpl<FVector2D>::GetInstance();
		case EPCGMetadataTypes::Vector:
			return &TTypeOpsImpl<FVector>::GetInstance();
		case EPCGMetadataTypes::Vector4:
			return &TTypeOpsImpl<FVector4>::GetInstance();
		case EPCGMetadataTypes::Quaternion:
			return &TTypeOpsImpl<FQuat>::GetInstance();
		case EPCGMetadataTypes::Rotator:
			return &TTypeOpsImpl<FRotator>::GetInstance();
		case EPCGMetadataTypes::Transform:
			return &TTypeOpsImpl<FTransform>::GetInstance();
		case EPCGMetadataTypes::String:
			return &TTypeOpsImpl<FString>::GetInstance();
		case EPCGMetadataTypes::Name:
			return &TTypeOpsImpl<FName>::GetInstance();
		case EPCGMetadataTypes::SoftObjectPath:
			return &TTypeOpsImpl<FSoftObjectPath>::GetInstance();
		case EPCGMetadataTypes::SoftClassPath:
			return &TTypeOpsImpl<FSoftClassPath>::GetInstance();
		default:
			return nullptr;
		}
	}
	...
	// TTypeOpsImpl instantiations - only 15 (14 types + SoftClassPath)
