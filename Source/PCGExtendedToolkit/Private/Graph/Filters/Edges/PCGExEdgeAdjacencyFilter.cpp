...
#include "Graph/Filters/Edges/PCGExEdgeAdjacencyFilter.h"


#include "Graph/PCGExGraph.h"

#define LOCTEXT_NAMESPACE "PCGExEdgeAdjacencyFilter"
#define PCGEX_NAMESPACE EdgeAdjacencyFilter

TSharedPtr<PCGExPointFilter::TFilter> UPCGExEdgeAdjacencyFilterFactory::CreateFilter() const
{
	return MakeShared<FEdgeAdjacencyFilter>(this);
}

bool FEdgeAdjacencyFilter::Init(const FPCGContext* InContext, const TSharedPtr<PCGExCluster::FCluster>& InCluster, const TSharedPtr<PCGExData::FFacade>& InPointDataFacade, const TSharedPtr<PCGExData::FFacade>& InEdgeDataFacade)
{
...
bool FEdgeAdjacencyFilter::Test(const PCGExCluster::FNode& Node) const
{
	return TestSubFunc(Node, *Cluster->Nodes, OperandA->Read(Node.PointIndex));
}


PCGEX_CREATE_FILTER_FACTORY(EdgeAdjacency)

#if WITH_EDITOR
FString UPCGExEdgeAdjacencyFilterProviderSettings::GetDisplayName() const
{
