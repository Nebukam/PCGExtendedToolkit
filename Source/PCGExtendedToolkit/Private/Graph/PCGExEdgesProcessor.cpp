...
TArray<FPCGPinProperties> UPCGExEdgesProcessorSettings::InputPinProperties() const
{
	...
	PCGEX_PIN_POINTS(PCGExGraph::SourceEdgesLabel, "Edges associated with the main input points")
...
TArray<FPCGPinProperties> UPCGExEdgesProcessorSettings::OutputPinProperties() const
{
	...
	PCGEX_PIN_POINTS(PCGExGraph::OutputEdgesLabel, "Edges associated with the main output points")
	return PinProperties;
}
