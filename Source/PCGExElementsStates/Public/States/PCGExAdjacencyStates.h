...
struct PCGEXELEMENTSSTATES_API FPCGExAdjacencyStateConfigBase
{
	GENERATED_BODY()
...
class PCGEXELEMENTSSTATES_API UPCGExAdjacencyStateFactoryData : public UPCGExClusterStateFactoryData
{
	GENERATED_BODY()
...
{
	class PCGEXELEMENTSSTATES_API FState final : public PCGExClusterStates::FState
	{
	protected:
	...
	public:
		...
		virtual void ProcessFlags(const bool bSuccess, int64& InFlags, const PCGExCluster::FNode& Node) const override;
		virtual void ProcessFlags(const bool bSuccess, int64& InFlags, const PCGExGraph::FEdge& Edge) const override;
...
class PCGEXELEMENTSSTATES_API UPCGExAdjacencyStateFactoryProviderSettings : public UPCGExStateFactoryProviderSettings
{
	GENERATED_BODY()
