...
struct PCGEXELEMENTSSTATES_API FPCGExStateConfigBase
{
	GENERATED_BODY()
...
class PCGEXELEMENTSSTATES_API UPCGExPointStateFactoryData : public UPCGExClusterFilterFactoryData
{
...
namespace PCGExPointStates
{
	...
	class PCGEXELEMENTSSTATES_API FState final : public PCGExPointFilter::IFilter
	{
	public:
		FPCGExStateConfigBase BaseConfig;
	...
	class PCGEXELEMENTSSTATES_API FStateManager final : public PCGExPointFilter::FManager
	{
...
class PCGEXELEMENTSSTATES_API UPCGExStateFactoryProviderSettings : public UPCGExFactoryProviderSettings
{
	GENERATED_BODY()
