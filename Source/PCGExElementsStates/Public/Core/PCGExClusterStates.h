...
struct PCGEXELEMENTSSTATES_API FPCGExClusterStateConfigBase : public FPCGExStateConfigBase
{
	GENERATED_BODY()
...
{
	GENERATED_BODY()
	PCG_DECLARE_TYPE_INFO(PCGEXELEMENTSSTATES_API)
};
...
class PCGEXELEMENTSSTATES_API UPCGExClusterStateFactoryData : public UPCGExPointStateFactoryData
{
	GENERATED_BODY()
...
{
	class PCGEXELEMENTSSTATES_API FState : public PCGExClusterFilter::IFilter
	{
	public:
		FPCGExClusterStateConfigBase Config;
	...
	class PCGEXELEMENTSSTATES_API FStateManager final : public PCGExClusterFilter::FManager
	{
...
class PCGEXELEMENTSSTATES_API UPCGExClusterStateFactoryProviderSettings : public UPCGExStateFactoryProviderSettings
{
	GENERATED_BODY()
