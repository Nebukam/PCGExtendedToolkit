...
/**
 * Visualizer for FPCGExConstraint_VolumeOffset.
 * Draws a wireframe box at the connector position.
 */
class PCGEXELEMENTSVALENCYEDITOR_API FVolumeOffsetVisualizer : public IConstraintVisualizer
{
public:
