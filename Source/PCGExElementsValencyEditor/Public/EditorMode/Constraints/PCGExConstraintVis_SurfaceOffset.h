...
/**
 * Visualizer for FPCGExConstraint_SurfaceOffset.
 * Draws a wireframe rectangle on the connector face plane.
 */
class PCGEXELEMENTSVALENCYEDITOR_API FSurfaceOffsetVisualizer : public IConstraintVisualizer
{
public:
