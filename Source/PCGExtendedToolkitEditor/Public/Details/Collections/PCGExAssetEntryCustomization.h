...
class PCGEXTENDEDTOOLKITEDITOR_API FPCGExAssetEntryCustomization : public IPropertyTypeCustomization
{
public:
...
class PCGEXTENDEDTOOLKITEDITOR_API FPCGExMeshEntryCustomization : public FPCGExAssetEntryCustomization
{
public:
...
class PCGEXTENDEDTOOLKITEDITOR_API FPCGExActorEntryCustomization : public FPCGExAssetEntryCustomization
{
public:
	static TSharedRef<IPropertyTypeCustomization> MakeInstance();
