...
#include "PCGExFillControlHeuristicsScoring.generated.h"
...
{
	friend class UPCGExFillControlsFactoryHeuristicsScoring;
...
class UPCGExFillControlsFactoryHeuristicsScoring : public UPCGExFillControlsFactoryData
{
	GENERATED_BODY()
...
public:
	...
	virtual FLinearColor GetNodeTitleColor() const override { return PCGEX_NODE_COLOR_NAME(FillControlScore); }
#endif
	//~End UPCGSettings
