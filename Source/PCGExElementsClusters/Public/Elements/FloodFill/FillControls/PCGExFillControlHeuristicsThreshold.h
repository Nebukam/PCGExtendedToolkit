...
#include "PCGExFillControlHeuristicsThreshold.generated.h"
...
{
	friend class UPCGExFillControlsFactoryHeuristicsThreshold;
...
class UPCGExFillControlsFactoryHeuristicsThreshold : public UPCGExFillControlsFactoryData
{
	GENERATED_BODY()
