...
public:
	//~Begin UPCGSettings
#if WITH_EDITOR
	PCGEX_NODE_INFOS_CUSTOM_SUBTITLE(EdgeNeighborsCountFilterFactory, "Edge Filter : Num Neighbors", "Check against the edge' endpoints neighbor count.", PCGEX_FACTORY_NAME_PRIORITY)
