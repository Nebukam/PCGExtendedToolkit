...
#include "Elements/FloodFill/FillControls/PCGExFillControlHeuristicsScoring.h"
...
bool FPCGExFillControlHeuristicsScoring::PrepareForDiffusions(FPCGExContext* InContext, const TSharedPtr<PCGExFloodFill::FFillControlsHandler>& InHandler)
{
	...
	const UPCGExFillControlsFactoryHeuristicsScoring* TypedFactory = Cast<UPCGExFillControlsFactoryHeuristicsScoring>(Factory);
...
TSharedPtr<FPCGExFillControlOperation> UPCGExFillControlsFactoryHeuristicsScoring::CreateOperation(FPCGExContext* InContext) const
{
...
void UPCGExFillControlsFactoryHeuristicsScoring::RegisterBuffersDependencies(FPCGExContext* InContext, PCGExData::FFacadePreloader& FacadePreloader) const
{
...
{
	UPCGExFillControlsFactoryHeuristicsScoring* NewFactory = InContext->ManagedObjects->New<UPCGExFillControlsFactoryHeuristicsScoring>();
