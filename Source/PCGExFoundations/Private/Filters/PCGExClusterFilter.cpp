...
FName UPCGExVtxFilterProviderSettings::GetMainOutputPin() const { return PCGExFilter::Labels::OutputFilterLabelNode; }

PCG_DEFINE_TYPE_INFO(FPCGExDataTypeInfoFilterEdge, UPCGExEdgeFilterFactoryData)

FName UPCGExEdgeFilterProviderSettings::GetMainOutputPin() const { return PCGExFilter::Labels::OutputFilterLabelEdge; }
