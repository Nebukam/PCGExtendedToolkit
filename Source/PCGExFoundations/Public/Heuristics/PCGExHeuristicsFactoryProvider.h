...
struct PCGEXFOUNDATIONS_API FPCGExHeuristicConfigBase
{
	GENERATED_BODY()
...
class PCGEXFOUNDATIONS_API UPCGExHeuristicsFactoryData : public UPCGExFactoryData
{
	GENERATED_BODY()
...
class PCGEXFOUNDATIONS_API UPCGExHeuristicsFactoryProviderSettings : public UPCGExFactoryProviderSettings
{
	GENERATED_BODY()
