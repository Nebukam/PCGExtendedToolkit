...
namespace PCGExTopology
{
	...
	PCGEXFOUNDATIONS_API void SetPointProperty(PCGExData::FMutablePoint& InPoint, const double InValue, const EPCGExPointPropertyOutput InProperty);
...
#pragma region Cell
	...
	struct PCGEXFOUNDATIONS_API FCellData
	{
		int8 bIsValid = 0;
		uint32 CellHash = 0;
	...
	class PCGEXFOUNDATIONS_API FCell : public TSharedFromThis<FCell>
	{
	protected:
		int32 Sign = 0;
		uint64 CellHash = 0;
