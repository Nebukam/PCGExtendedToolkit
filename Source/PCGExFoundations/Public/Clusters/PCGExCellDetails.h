...
struct PCGEXFOUNDATIONS_API FPCGExCellConstraintsDetails
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct PCGEXFOUNDATIONS_API FPCGExCellSeedMutationDetails
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct PCGEXFOUNDATIONS_API FPCGExCellArtifactsDetails
{
	GENERATED_BODY()
