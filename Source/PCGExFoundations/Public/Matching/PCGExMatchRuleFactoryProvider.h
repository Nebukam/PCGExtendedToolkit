...
struct PCGEXFOUNDATIONS_API FPCGExMatchRuleConfigBase
{
	GENERATED_BODY()
 ...
 * 
 */
class PCGEXFOUNDATIONS_API FPCGExMatchRuleOperation : public FPCGExOperation
{
public:
...
class PCGEXFOUNDATIONS_API UPCGExMatchRuleFactoryData : public UPCGExFactoryData
{
	GENERATED_BODY()
...
class PCGEXFOUNDATIONS_API UPCGExMatchRuleFactoryProviderSettings : public UPCGExFactoryProviderSettings
{
	GENERATED_BODY()
