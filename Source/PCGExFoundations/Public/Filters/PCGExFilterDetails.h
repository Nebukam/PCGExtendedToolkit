...
struct PCGEXFOUNDATIONS_API FPCGExFilterResultDetails
{
	GENERATED_BODY()
...
namespace PCGEx
{
	PCGEXFOUNDATIONS_API void TagsToData(UPCGData* Data, const TSharedPtr<PCGExData::FTags>& Tags, const EPCGExTagsToDataAction Action);

	PCGEXFOUNDATIONS_API void TagsToData(const TSharedPtr<PCGExData::FPointIO>& Data, const EPCGExTagsToDataAction Action);
}
