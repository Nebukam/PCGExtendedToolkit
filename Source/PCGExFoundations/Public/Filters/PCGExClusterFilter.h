...
class PCGEXFOUNDATIONS_API UPCGExClusterFilterFactoryData : public UPCGExPointFilterFactoryData
{
	GENERATED_BODY()
 ...
 */
UCLASS(Abstract, BlueprintType, ClassGroup = (Procedural), Category="PCGEx|Data")
class PCGEXFOUNDATIONS_API UPCGExNodeFilterFactoryData : public UPCGExClusterFilterFactoryData
{
	GENERATED_BODY()
 ...
 */
UCLASS(Abstract, BlueprintType, ClassGroup = (Procedural), Category="PCGEx|Data")
class PCGEXFOUNDATIONS_API UPCGExEdgeFilterFactoryData : public UPCGExClusterFilterFactoryData
{
	GENERATED_BODY()
...
{
	class PCGEXFOUNDATIONS_API IFilter : public PCGExPointFilter::IFilter
	{
	public:
	...
	class PCGEXFOUNDATIONS_API IVtxFilter : public IFilter
	{
	public:
	...
	class PCGEXFOUNDATIONS_API IEdgeFilter : public IFilter
	{
	public:
	...
	class PCGEXFOUNDATIONS_API FManager : public PCGExPointFilter::FManager
	{
	public:
