...
struct PCGEXFOUNDATIONS_API FPCGExBitmaskCollectionEntry
{
	GENERATED_BODY()
...
{
	class PCGEXFOUNDATIONS_API FCache : public TSharedFromThis<FCache>
	{
	public:
...
class PCGEXFOUNDATIONS_API UPCGExBitmaskCollection : public UDataAsset
{
