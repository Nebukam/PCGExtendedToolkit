...
struct PCGEXFOUNDATIONS_API FPCGExClampedBit
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct PCGEXFOUNDATIONS_API FPCGExClampedBitOp : public FPCGExClampedBit
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct PCGEXFOUNDATIONS_API FPCGExSimpleBitmask
{
	GENERATED_BODY()
...
struct PCGEXFOUNDATIONS_API FPCGExBitmaskRef
{
	GENERATED_BODY()
...
struct PCGEXFOUNDATIONS_API FPCGExBitmask
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct PCGEXFOUNDATIONS_API FPCGExBitmaskWithOperation
{
	GENERATED_BODY()
