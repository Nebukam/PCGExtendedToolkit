...
class PCGEXTOPOLOGIES_API UPCGExTopologyPathSurfaceSettings : public UPCGExPathProcessorSettings
{
	GENERATED_BODY()
...
struct PCGEXTOPOLOGIES_API FPCGExTopologyPathSurfaceContext : FPCGExPathProcessorContext
{
	friend class FPCGExTopologyPathSurfaceElement;
...
class PCGEXTOPOLOGIES_API FPCGExTopologyPathSurfaceElement : public FPCGExPathProcessorElement
{
protected:
...
{
	class PCGEXTOPOLOGIES_API FProcessor : public PCGExPointsMT::TProcessor<FPCGExTopologyPathSurfaceContext, UPCGExTopologyPathSurfaceSettings>
	{
	protected:
