...
class PCGEXTOPOLOGIES_API UPCGExTopologyClustersProcessorSettings : public UPCGExClustersProcessorSettings
{
	GENERATED_BODY()
...
struct PCGEXTOPOLOGIES_API FPCGExTopologyClustersProcessorContext : FPCGExClustersProcessorContext
{
	friend class FPCGExTopologyClustersProcessorElement;
...
class PCGEXTOPOLOGIES_API FPCGExTopologyClustersProcessorElement : public FPCGExClustersProcessorElement
{
protected:
...
namespace PCGExTopologyEdges
{
	...
	class PCGEXTOPOLOGIES_API IProcessor : public PCGExClusterMT::IProcessor
	{
		friend class IBatch;
	...
	class PCGEXTOPOLOGIES_API TProcessor : public IProcessor
	{
	protected:
	...
	class PCGEXTOPOLOGIES_API IBatch : public PCGExClusterMT::IBatch
	{
	protected:
		const FVector2D CWTolerance = FVector2D(0.001);
		TSharedPtr<TMap<uint64, int32>> ProjectedHashMap;
	...
	template <typename T>
	class PCGEXTOPOLOGIES_API TBatch : public IBatch
	{
	protected:
