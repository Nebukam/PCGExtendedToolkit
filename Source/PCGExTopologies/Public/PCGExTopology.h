...
struct PCGEXTOPOLOGIES_API FPCGExUVInputDetails
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct PCGEXTOPOLOGIES_API FPCGExTopologyUVDetails
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct PCGEXTOPOLOGIES_API FPCGExTopologyDetails
{
	GENERATED_BODY()
...
namespace PCGExTopology
{
	...
	PCGEXTOPOLOGIES_API void MarkTriangle(const TSharedPtr<PCGExCluster::FCluster>& InCluster, const PCGExMath::FTriangle& InTriangle);
