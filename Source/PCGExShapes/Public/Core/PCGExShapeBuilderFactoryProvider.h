...
{
	GENERATED_BODY()
	PCG_DECLARE_TYPE_INFO(PCGEXSHAPES_API)
};

UCLASS(Abstract, BlueprintType, ClassGroup = (Procedural), Category="PCGEx|Data")
class PCGEXSHAPES_API UPCGExShapeBuilderFactoryData : public UPCGExFactoryData
{
	GENERATED_BODY()
...
class PCGEXSHAPES_API UPCGExShapeBuilderFactoryProviderSettings : public UPCGExFactoryProviderSettings
{
	GENERATED_BODY()
