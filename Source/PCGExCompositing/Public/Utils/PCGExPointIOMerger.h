...
{
	struct PCGEXCOMPOSITING_API FIdentityRef : PCGExData::FAttributeIdentity
	{
	...
	struct PCGEXCOMPOSITING_API FMergeScope
	{
		PCGExMT::FScope Read;
...
class PCGEXCOMPOSITING_API FPCGExPointIOMerger final : public TSharedFromThis<FPCGExPointIOMerger>
{
