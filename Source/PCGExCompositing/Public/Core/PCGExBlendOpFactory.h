...
struct PCGEXCOMPOSITING_API FPCGExAttributeBlendWeight
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct PCGEXCOMPOSITING_API FPCGExAttributeBlendConfig
{
	GENERATED_BODY()
 ...
 * 
 */
class PCGEXCOMPOSITING_API FPCGExBlendOperation : public FPCGExOperation
{
public:
...
{
	GENERATED_BODY()
	PCG_DECLARE_TYPE_INFO(PCGEXCOMPOSITING_API)
};

UCLASS(BlueprintType, ClassGroup = (Procedural), Category="PCGEx|Blending")
class PCGEXCOMPOSITING_API UPCGExBlendOpFactory : public UPCGExFactoryData
{
	GENERATED_BODY()
