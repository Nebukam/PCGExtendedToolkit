...
struct PCGEXCOMPOSITING_API FPCGExBoxIntersectionDetails
{
	GENERATED_BODY()
...
#pragma region Compound Graph
	...
	class PCGEXCOMPOSITING_API FUnionNode : public TSharedFromThis<FUnionNode>
	{
	protected:
	...
	class PCGEXCOMPOSITING_API FUnionGraph : public TSharedFromThis<FUnionGraph>
	{
...
#pragma endregion
	...
	class PCGEXCOMPOSITING_API FIntersectionCache : public TSharedFromThis<FIntersectionCache>
	{
	public:
	...
	class PCGEXCOMPOSITING_API FEdgeProxy : public TSharedFromThis<FEdgeProxy>
	{
	public:
...
#pragma region Point Edge intersections
	...
	struct PCGEXCOMPOSITING_API FPESplit
	{
		int32 Index = -1;
		double Time = -1;
	...
	class PCGEXCOMPOSITING_API FPointEdgeProxy : public FEdgeProxy
	{
	public:
	...
	class PCGEXCOMPOSITING_API FPointEdgeIntersections : public FIntersectionCache
	{
	public:
...
#pragma region Edge Edge intersections
	...
	struct PCGEXCOMPOSITING_API FEESplit
	{
		FEESplit() = default;
	...
	struct PCGEXCOMPOSITING_API FEECrossing
	{
		int32 Index = -1;
		FEESplit Split;
	...
	class PCGEXCOMPOSITING_API FEdgeEdgeProxy : public FEdgeProxy
	{
	public:
	...
	class PCGEXCOMPOSITING_API FEdgeEdgeIntersections : public FIntersectionCache
	{
	public:
