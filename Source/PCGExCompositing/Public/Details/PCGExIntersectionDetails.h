...
struct PCGEXCOMPOSITING_API FPCGExInclusionDetails
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct PCGEXCOMPOSITING_API FPCGExUnionMetadataDetails
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct PCGEXCOMPOSITING_API FPCGExPointUnionMetadataDetails : public FPCGExUnionMetadataDetails
{
	GENERATED_BODY()
};

USTRUCT(BlueprintType)
struct PCGEXCOMPOSITING_API FPCGExEdgeUnionMetadataDetails : public FPCGExUnionMetadataDetails
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct PCGEXCOMPOSITING_API FPCGExPointPointIntersectionDetails
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct PCGEXCOMPOSITING_API FPCGExPointEdgeIntersectionDetails
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct PCGEXCOMPOSITING_API FPCGExEdgeEdgeIntersectionDetails
{
	GENERATED_BODY()
