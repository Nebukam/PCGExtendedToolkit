...
struct PCGEXCOMPOSITING_API FPCGExFuseDetailsBase
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct PCGEXCOMPOSITING_API FPCGExSourceFuseDetails : public FPCGExFuseDetailsBase
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct PCGEXCOMPOSITING_API FPCGExFuseDetails : public FPCGExSourceFuseDetails
{
	GENERATED_BODY()
