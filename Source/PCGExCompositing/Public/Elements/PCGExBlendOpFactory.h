...
struct PCGEXCORE_API FPCGExAttributeBlendWeight
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct PCGEXCORE_API FPCGExAttributeBlendConfig
{
	GENERATED_BODY()
 ...
 * 
 */
class PCGEXCORE_API FPCGExBlendOperation : public FPCGExOperation
{
public:
...
class PCGEXCORE_API UPCGExBlendOpFactory : public UPCGExFactoryData
{
	GENERATED_BODY()
