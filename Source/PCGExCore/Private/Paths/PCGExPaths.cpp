...
#include "Paths/PCGExPathHelpers.h"
...
namespace PCGExPaths
{
	...
	PCGExMath::FClosestPosition FPath::Helpers::FindClosestIntersection(const FPCGExPathIntersectionDetails& InDetails, const PCGExMath::FSegment& Segment) const
	{
	...
	PCGExMath::FClosestPosition FPath::Helpers::FindClosestIntersection(const FPCGExPathIntersectionDetails& InDetails, const PCGExMath::FSegment& Segment, PCGExMath::FClosestPosition& OutClosestPosition) const
	{
		PCGExMath::FClosestPosition Closest(Segment.A);
