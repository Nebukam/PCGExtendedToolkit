...
{
	struct PCGEXCORE_API FIdentityRef : PCGExData::FAttributeIdentity
	{
	...
	struct PCGEXCORE_API FMergeScope
	{
		PCGExMT::FScope Read;
...
class PCGEXCORE_API FPCGExPointIOMerger final : public TSharedFromThis<FPCGExPointIOMerger>
{
