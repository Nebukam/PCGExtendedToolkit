...
struct PCGEXCORE_API FPCGExMatchRuleConfigBase
{
	GENERATED_BODY()
 ...
 * 
 */
class PCGEXCORE_API FPCGExMatchRuleOperation : public FPCGExOperation
{
public:
...
class PCGEXCORE_API UPCGExMatchRuleFactoryData : public UPCGExFactoryData
{
	GENERATED_BODY()
...
class PCGEXCORE_API UPCGExMatchRuleFactoryProviderSettings : public UPCGExFactoryProviderSettings
{
	GENERATED_BODY()
