...
struct PCGEXCORE_API FPCGExMatchingDetails
{
	GENERATED_BODY()
...
namespace PCGExMatching
{
	...
	PCGEXCORE_API void DeclareMatchingRulesInputs(const FPCGExMatchingDetails& InDetails, TArray<FPCGPinProperties>& PinProperties);

	PCGEXCORE_API void DeclareMatchingRulesOutputs(const FPCGExMatchingDetails& InDetails, TArray<FPCGPinProperties>& PinProperties);
}
