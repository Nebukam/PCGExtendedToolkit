...
struct PCGEXCORE_API FPCGExPrimitiveComponentDescriptor
{
	GENERATED_BODY()
...
struct PCGEXCORE_API FPCGExMeshComponentDescriptor : public FPCGExPrimitiveComponentDescriptor
{
	GENERATED_BODY()
...
struct PCGEXCORE_API FPCGExStaticMeshComponentDescriptor : public FPCGExMeshComponentDescriptor
{
	GENERATED_BODY()
...
struct PCGEXCORE_API FPCGExDynamicMeshDescriptor : public FPCGExMeshComponentDescriptor
{
	GENERATED_BODY()
